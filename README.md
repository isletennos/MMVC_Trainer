...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](http://colab.research.google.com/github/isletennos/MMVC_Trainer/blob/v1.5.0.0_SiFiGAN/notebook/01_Clone_Repo.ipynb)
...
2. dataset/textful/00_myvoice に音声データを配置します。  
...
3. notebookディレクトリにある「03_Create_Configfile.ipynb」をGoogle Colab 上で実行、学習に必要なconfigファイルを作成します  
...
https://discord.gg/2MGysH3QpD  に関するコミュニティサーバです。  
